...
//			{Coins.SHIB, Coins.DOGE, Coins.DOGE},
	...
	public static final int[] reel1 = { 10,   15,    15,    25,    35 };
	public static final int[] reel2 = { 5,    10,    20,    25,    40 };
	public static final int[] reel3 = { 5,    15,    20,    25,    35 };
...
//	public static double bitcoinIncrease = 1.1;
	...
	public static double payoutBasisPoint = 9.0;
	public static double bitcoinIncrease = 1;
...
//			realPayouts[i] = ((double)USDTh.round((10_000 * payoutBasisPoint ) / (double)waysToMakeCombo[i])) / 10_000.0;
			...
			if (realPayouts[i] < 0.5) {
				...
				realPayouts[i] = 0.5;
			} else if (realPayouts[i] < 0.75) {
				System.out.println("BELOW 0.75: " + combos[i][0] + " " + combos[i][1] + " " + combos[i][2] + " => " + realPayouts[i]);
				realPayouts[i] = 0.75;
