...
//				{Coins.MAT, Coins.DOG, Coins.BTC},
		...
		public static final int[] reel1 = { 9,   20,   30,   40,   40,   40,  50 };
		public static final int[] reel2 = { 9,   20,   40,   40,   35,   40,  50 };
		public static final int[] reel3 = { 9,   20,   40,   40,   40,   40,  60 };
...
//		public static final int[] combinedReel3 = { 1, 3, 7, 10, 14, 17, 22 };
		...
		public static double payoutBasisPoint = 55;
...
//				realPayouts[i] = ((double)Math.round((10_000 * payoutBasisPoint ) / (double)waysToMakeCombo[i])) / 10_000.0;
				...
				else if (combos[i][0] == Coins.BTC && combos[i][1] == Coins.BTC && combos[i][2] == Coins.MAT) {
					realPayouts[i] = 20;
				}
