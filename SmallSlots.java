...
public class SmallSlots {
		...
		public static final Coins[][] combos = {
				...
				/** NEWEST EDITION SINCE PUBLIC BETA */
				{Coins.BNB, Coins.ETH, Coins.BTC},
				/** END NEWEST EDITION SINCE PUBLIC BETA */
...
//				{Coins.MAT, Coins.XRP, Coins.XRP},
		...
		public static final int[] reel1 = { 1,   2,   3,   3,   3,   4,    4 };
		public static final int[] reel2 = { 1,   2,   4,   3,   3,   3,    4 };
		public static final int[] reel3 = { 1,   2,   4,   3,   4,   3,    3 };
		
		public static final int[] combinedReel1 = { 1, 3, 6, 9,  12, 16, 20 };
		public static final int[] combinedReel2 = { 1, 3, 7, 10, 13, 16, 20 };
		public static final int[] combinedReel3 = { 1, 3, 7, 10, 14, 17, 20 };
