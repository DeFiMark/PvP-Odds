...
//				{Coins.BTC, Coins.MAT, Coins.DOG}, // <- this one controversial
...
//				{Coins.BTC, Coins.XRP, Coins.SOL},
				{Coins.BTC, Coins.XRP, Coins.XRP},
...
//				{Coins.ETH, Coins.MAT, Coins.SOL},
				...
				{Coins.ETH, Coins.DOG, Coins.SOL},
				{Coins.ETH, Coins.DOG, Coins.DOG},
				
				{Coins.ETH, Coins.XRP, Coins.BTC},
				{Coins.ETH, Coins.XRP, Coins.ETH},
				{Coins.ETH, Coins.XRP, Coins.XRP},
				...
				{Coins.BNB, Coins.BNB, Coins.MAT},
				{Coins.BNB, Coins.BNB, Coins.XRP},
				
//				{Coins.BNB, Coins.DOG, Coins.DOG},
				{Coins.BNB, Coins.DOG, Coins.BTC},
				{Coins.BNB, Coins.DOG, Coins.ETH},
				{Coins.BNB, Coins.DOG, Coins.BNB},
//				{Coins.BNB, Coins.DOG, Coins.SOL},
   				
				{Coins.BNB, Coins.MAT, Coins.BTC},
				{Coins.BNB, Coins.MAT, Coins.ETH},
				{Coins.BNB, Coins.MAT, Coins.BNB},
				{Coins.BNB, Coins.MAT, Coins.SOL},
				{Coins.BNB, Coins.MAT, Coins.MAT},			
				{Coins.BNB, Coins.MAT, Coins.DOG},
				{Coins.BNB, Coins.MAT, Coins.XRP},
				
				{Coins.XRP, Coins.DOG, Coins.DOG},				
				
				{Coins.XRP, Coins.BTC, Coins.BTC},
				...
				{Coins.SOL, Coins.BTC, Coins.BNB},
				{Coins.SOL, Coins.BTC, Coins.DOG},
...
//				{Coins.MAT, Coins.XRP, Coins.SOL},
		...
		public static final int[] reel1 = { 1,   2,   3,   3,   3,   4,    7 };
		public static final int[] reel2 = { 1,   2,   4,   3,   3,   3,    6 };
		public static final int[] reel3 = { 1,   2,   4,   3,   4,   3,    5 };
		
		public static final int[] combinedReel1 = { 1, 3, 6, 9,  12, 16, 23 };
		public static final int[] combinedReel2 = { 1, 3, 7, 10, 13, 16, 22 };
		public static final int[] combinedReel3 = { 1, 3, 7, 10, 14, 17, 22 };
...
//		public static double boostToLowestPayouts = 1;// 1.38;
		...
		public static void run() {
			...
			for (int i = 0; i < combos.length; i++) {
				...
				if (combos[i][0] == Coins.MAT && combos[i][1] == Coins.MAT && combos[i][2] == Coins.BNB) {
					realPayouts[i] = 0.8;
				} else if (combos[i][0] == Coins.MAT && combos[i][1] == Coins.MAT && combos[i][2] == Coins.XRP) {
					realPayouts[i] = 0.75;
				} else if (combos[i][0] == Coins.MAT && combos[i][1] == Coins.MAT && combos[i][2] == Coins.SOL) {
					realPayouts[i] = 1;
				} else if (combos[i][0] == Coins.MAT && combos[i][1] == Coins.MAT && combos[i][2] == Coins.DOG) {
					realPayouts[i] = 1;
				} else if (combos[i][0] == Coins.MAT && combos[i][1] == Coins.BNB && combos[i][2] == Coins.BNB) {
					realPayouts[i] = 1.1;
				} else if (combos[i][0] == Coins.MAT && combos[i][1] == Coins.BNB && combos[i][2] == Coins.XRP) {
					realPayouts[i] = 1.1;
...
//					System.out.println(i + ":" + j + ":" + comboLengths[i][j][0]);
			...
			System.out.println("\n\nPrinting Combos Over 1% Chance To Hit\n\n");
			for (int i = 0; i < combos.length; i++) {
				double odds = 100*(double)waysToMakeCombo[i]/(double)nCombinations;
				if (odds > 1) {
					System.out.printf("%s, %s, %s => %.2f%%\n", combos[i][0], combos[i][1], combos[i][2], odds);
				}
			}
