...
public class shitcoinAlley {
			...
			public static final Coins[][] combos = {
					...
					{Coins.BTC, Coins.MAT, Coins.XRP},
					{Coins.BTC, Coins.MAT, Coins.MAT},
					{Coins.BTC, Coins.MAT, Coins.DOG},
					
					{Coins.BTC, Coins.XRP, Coins.BTC},
					{Coins.BTC, Coins.XRP, Coins.ETH},
					{Coins.BTC, Coins.XRP, Coins.BNB},
					...
					{Coins.ETH, Coins.XRP, Coins.ETH},
					{Coins.ETH, Coins.XRP, Coins.BTC},
					...
					{Coins.BNB, Coins.DOG, Coins.DOG},
					
					{Coins.BNB, Coins.BNB, Coins.SOL},
					{Coins.BNB, Coins.BNB, Coins.DOG},
					
					{Coins.BNB, Coins.MAT, Coins.SOL},
					{Coins.BNB, Coins.MAT, Coins.BNB},
					{Coins.BNB, Coins.MAT, Coins.ETH},
					{Coins.BNB, Coins.MAT, Coins.DOG},
					
					{Coins.XRP, Coins.DOG, Coins.DOG},	
					{Coins.XRP, Coins.DOG, Coins.XRP},	
					{Coins.XRP, Coins.DOG, Coins.BTC},	
					{Coins.XRP, Coins.DOG, Coins.ETH},	
					
					{Coins.XRP, Coins.BTC, Coins.ETH},
					{Coins.XRP, Coins.BTC, Coins.BNB},
					{Coins.XRP, Coins.BTC, Coins.SOL},
					{Coins.XRP, Coins.BTC, Coins.XRP},
					{Coins.XRP, Coins.BTC, Coins.DOG},
					
					{Coins.XRP, Coins.ETH, Coins.BTC},
					{Coins.XRP, Coins.ETH, Coins.ETH},
					{Coins.XRP, Coins.ETH, Coins.BNB},
					{Coins.XRP, Coins.ETH, Coins.SOL},
					{Coins.XRP, Coins.ETH, Coins.XRP},
					{Coins.XRP, Coins.ETH, Coins.DOG},
					
					{Coins.XRP, Coins.BNB, Coins.BTC},
					{Coins.XRP, Coins.BNB, Coins.ETH},
					{Coins.XRP, Coins.BNB, Coins.BNB},
					{Coins.XRP, Coins.BNB, Coins.SOL},
					{Coins.XRP, Coins.BNB, Coins.XRP},
					{Coins.XRP, Coins.BNB, Coins.DOG},
					
					{Coins.XRP, Coins.XRP, Coins.BTC},
					{Coins.XRP, Coins.XRP, Coins.ETH},
					{Coins.XRP, Coins.XRP, Coins.BNB},
					{Coins.XRP, Coins.XRP, Coins.SOL},
					{Coins.XRP, Coins.XRP, Coins.DOG},
					
					{Coins.XRP, Coins.MAT, Coins.BTC},
					{Coins.XRP, Coins.MAT, Coins.ETH},
					{Coins.XRP, Coins.MAT, Coins.BNB},
					{Coins.XRP, Coins.MAT, Coins.SOL},
					{Coins.XRP, Coins.MAT, Coins.XRP},
					{Coins.XRP, Coins.MAT, Coins.DOG},
					
				
					{Coins.SOL, Coins.SOL, Coins.BTC},
					{Coins.SOL, Coins.SOL, Coins.ETH},
					{Coins.SOL, Coins.SOL, Coins.BNB},
					{Coins.SOL, Coins.SOL, Coins.XRP},
					{Coins.SOL, Coins.SOL, Coins.MAT},
					{Coins.SOL, Coins.SOL, Coins.DOG},
					...
					{Coins.SOL, Coins.ETH, Coins.BNB},
					{Coins.SOL, Coins.ETH, Coins.SOL},
					{Coins.SOL, Coins.ETH, Coins.XRP},
					{Coins.SOL, Coins.ETH, Coins.DOG},
					
					{Coins.SOL, Coins.BNB, Coins.BTC},
					{Coins.SOL, Coins.BNB, Coins.ETH},
					{Coins.SOL, Coins.BNB, Coins.BNB},
					{Coins.SOL, Coins.BNB, Coins.SOL},
					
					{Coins.DOG, Coins.BTC, Coins.BTC},
					{Coins.DOG, Coins.BTC, Coins.ETH},
					{Coins.DOG, Coins.BTC, Coins.BNB},
					{Coins.DOG, Coins.BTC, Coins.SOL},
					{Coins.DOG, Coins.BTC, Coins.XRP},
					{Coins.DOG, Coins.BTC, Coins.DOG},
					
					{Coins.DOG, Coins.BNB, Coins.DOG},
					{Coins.DOG, Coins.ETH, Coins.DOG},
					
					{Coins.DOG, Coins.DOG, Coins.BTC},
					{Coins.DOG, Coins.DOG, Coins.BNB},
					{Coins.DOG, Coins.DOG, Coins.ETH},
					{Coins.DOG, Coins.DOG, Coins.SOL},
					{Coins.DOG, Coins.DOG, Coins.XRP},
					
					// New Additions
					{Coins.DOG, Coins.SOL, Coins.BTC},
					{Coins.DOG, Coins.SOL, Coins.ETH},
					{Coins.DOG, Coins.SOL, Coins.BNB},
					{Coins.DOG, Coins.SOL, Coins.DOG},
					{Coins.DOG, Coins.SOL, Coins.SOL},
					{Coins.DOG, Coins.SOL, Coins.XRP},
//					
					...
					{Coins.MAT, Coins.DOG, Coins.BNB},
					{Coins.MAT, Coins.DOG, Coins.SOL},
					{Coins.MAT, Coins.DOG, Coins.XRP},
					{Coins.MAT, Coins.DOG, Coins.DOG},
					
					{Coins.MAT, Coins.BTC, Coins.BTC},
					{Coins.MAT, Coins.BTC, Coins.ETH},
					{Coins.MAT, Coins.BTC, Coins.BNB},
					{Coins.MAT, Coins.BTC, Coins.SOL},
					{Coins.MAT, Coins.BTC, Coins.XRP},
					{Coins.MAT, Coins.BTC, Coins.DOG},
					
					{Coins.MAT, Coins.ETH, Coins.BTC},
					{Coins.MAT, Coins.ETH, Coins.ETH},
					{Coins.MAT, Coins.ETH, Coins.BNB},
					{Coins.MAT, Coins.ETH, Coins.SOL},
					{Coins.MAT, Coins.ETH, Coins.XRP},
					{Coins.MAT, Coins.ETH, Coins.DOG},
					
					{Coins.MAT, Coins.BNB, Coins.BTC},
					{Coins.MAT, Coins.BNB, Coins.ETH},
					{Coins.MAT, Coins.BNB, Coins.BNB},
					{Coins.MAT, Coins.BNB, Coins.SOL},
					{Coins.MAT, Coins.BNB, Coins.XRP},
					...
					{Coins.MAT, Coins.SOL, Coins.XRP},
					{Coins.MAT, Coins.SOL, Coins.DOG},
					
					{Coins.MAT, Coins.XRP, Coins.BTC},
					{Coins.MAT, Coins.XRP, Coins.ETH},
					{Coins.MAT, Coins.XRP, Coins.BNB},
					{Coins.MAT, Coins.XRP, Coins.SOL},
					{Coins.MAT, Coins.XRP, Coins.XRP},
					{Coins.MAT, Coins.XRP, Coins.DOG}
			};
			
			 									//   0		 1		2	   3	  4	     5        6
			public static final String[] options = {"BTC", "ETH", "BNB", "SOL", "XRP", "DOGE", "MATIC"};
										    // BTC  PEPE SHIB FLOKI BONK  DOGE  MATIC
			public static final int[] reel1 = { 1,   2,   3,    3,   6,    5,    5 };
			public static final int[] reel2 = { 1,   2,   3,    4,   7,    5,    3 };
			public static final int[] reel3 = { 1,   2,   4,    4,   7,    4,    3 };
			
			public static final int[] combinedReel1 = { 1, 3, 6, 9,  15, 20, 25 };
			public static final int[] combinedReel2 = { 1, 3, 6, 10, 17, 22, 25 };
			public static final int[] combinedReel3 = { 1, 3, 7, 11, 18, 22, 25 };

			public static double payoutBasisPoint = 75.0;
//			public static double boostToLowerPayouts = 1.1;
//			public static double boostToLowestPayouts = 1;// 1.38;
...
//					if (realPayouts[i] < 2) {
//						realPayouts[i] *= boostToLowestPayouts;
//					}
//					else if (realPayouts[i] <= 4) {
//						realPayouts[i] *= boostToLowerPayouts;
//					}
					...
					else if (combos[i][0] == Coins.XRP && combos[i][1] == Coins.XRP && combos[i][2] == Coins.XRP) {
						realPayouts[i] = 2.5;
					}
...
//					else if (combos[i][0] == Coins.BNB && combos[i][1] == Coins.MAT && combos[i][2] == Coins.DOG) {
//						realPayouts[i] = 1.25;
//					}
//					else if (combos[i][0] == Coins.BNB && combos[i][1] == Coins.BNB && combos[i][2] == Coins.DOG) {
//						realPayouts[i] = 1.35;
//					}
//					else if (combos[i][0] == Coins.BNB && combos[i][1] == Coins.DOG && combos[i][2] == Coins.DOG) {
//						realPayouts[i] = 1.3;
//					}
//					else if (combos[i][0] == Coins.MAT && combos[i][1] == Coins.MAT && combos[i][2] == Coins.DOG) {
//						realPayouts[i] = 1.25;
//					}
//					else if (combos[i][0] == Coins.MAT && combos[i][1] == Coins.BNB && combos[i][2] == Coins.DOG) {
//						realPayouts[i] = 1.25;
//					}
//					else if (combos[i][0] == Coins.MAT && combos[i][1] == Coins.SOL && combos[i][2] == Coins.DOG) {
//						realPayouts[i] = 1.25;
//					}
					
//					if (realPayouts[i] < 1.15) {
//						realPayouts[i] = 1.15;
//					}
...
//				}
				...
				for (int i = 0; i < realPayouts.length; i++) {
					System.out.print("0,");//System.out.print((int)(realPayouts[i] * 10_000) + ",");
				}
				System.out.print("]\n\n\n");
...
//						System.out.println(i + ":" + j + ":" + comboLengths[i][j][0]);
				...
				double fee = 0.011; // 1.1%
				double totalFees = 0;
				
				double jackpotFee = 0.0025; // 0.25%
